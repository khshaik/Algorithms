...
import static com.algorithms.graphtheory.treealgorithms.TreeIsomorphism.addUndirectedEdge;
import static com.algorithms.graphtheory.treealgorithms.TreeIsomorphism.createGraph;
import static com.algorithms.graphtheory.treealgorithms.TreeIsomorphism.treesAreIsomorphic;
  ...
  public void testIsomorphismEquivilanceAgainstOtherImpl() {
    for (int n = 1; n < 50; n++) {
      for (int loops = 0; loops < 1000; loops++) {
        ...
        boolean impl2 =
            TreeIsomorphismWithBfs.treesAreIsomorphic(tree1, tree2);
        if (impl1 != impl2) {
